...
class SupervisorDashboardScreen extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return SupervisorDashboardScreenState();
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Student Tutorial',style: TextStyle( fontSize: 16.0,color: Colors.black87,fontWeight: FontWeight.bold)),
              onTap: () {
                // Update the state of the app
                // ...
                // Then close the drawer
            ...
            ListTile(
              ...
              title: const Text('Reports',style: TextStyle( fontSize: 16.0,color: Colors.black87,fontWeight: FontWeight.bold)),
              onTap: () {
                // Update the state of the app
                // ...
                // Then close the drawer
            ...
            ListTile(
              leading: Icon(Icons.file_copy),
              title: const Text('Study Materials',style: TextStyle( fontSize: 16.0,color: Colors.black87,fontWeight: FontWeight.bold),),
              onTap: () {
                // Update the state of the app
                // ...
                // Then close the drawer
