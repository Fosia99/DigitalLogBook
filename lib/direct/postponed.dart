...
class DirectPostponed extends StatefulWidget {
  late final rotNum;

  DirectPostponed(this.rotNum);

  @override
  State<DirectPostponed> createState() => _DirectPostponedState(rotNum);

}

class _DirectPostponedState extends State<DirectPostponed> {
  late final rotNum;

  _DirectPostponedState(this.rotNum);
        ...
        builder: (BuildContext ctx) {
          ...
          child: SingleChildScrollView(   child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                      decoration: const InputDecoration(
                          labelText: "Identify client(s)", border: OutlineInputBorder()),
                      value: "Yes",
                      onChanged: (newValue) {
                        setState(() {
                    ...
                    DropdownButtonFormField(
                      ...
                      items: ['Individual Session ', 'Group Session','Caregiver training','Family psycho-education session','Wheelchair seating','Splint fabrication'].map((location) {
                        return DropdownMenuItem(
                          child: Text(location,
                              style: const TextStyle(
                                fontFamily: 'Raleway',
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'reasonsCancel'),
                    ),
                    const SizedBox(height: 15.0),
                    DropdownButtonFormField(
                      decoration: InputDecoration(
              ...
              Container(
                ...
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        .where('sessionStatus', isEqualTo: 'postponed')
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return FocusedMenuHolder(
                                ...
                                menuItems: [
                                  ...
                                  FocusedMenuItem(
                                      title: const Text("Session Conducted?"),
                                      trailingIcon: Icon(Icons.work),
                                      onPressed: () {

                                        direct
                                            .doc(documentSnapshot.id)
                                            .update({"sessionStatus": 'conduct session'});
