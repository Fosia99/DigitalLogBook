...
class IndirectPostponed extends StatefulWidget {
  late final rotNum;

  IndirectPostponed(this.rotNum);

  @override
  State<IndirectPostponed> createState() => _IndirectPostponedState(rotNum);
}

class _IndirectPostponedState extends State<IndirectPostponed> {
  late final rotNum;

  _IndirectPostponedState(this.rotNum);
        ...
        child:  Container(
                ...
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        .where('logStatus', isEqualTo: 'postponed')
                                                ...
                                                TextButton.icon(
                                                  ...
                                                  onPressed: () {
                                                    indirect
                                                        .doc(documentSnapshot.id)
                                                        .update({
                                                      "logStatus": 'conduct session'
                                                    });
                                                  },
                                                  label: const Text("Conducted",
                                                      style: TextStyle(
                                                          fontSize: 12,
                                                          color: Colors.black)),
                                                ),
