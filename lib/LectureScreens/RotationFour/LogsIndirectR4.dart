...
class LogsIndirectR4 extends StatefulWidget {
  static String TAG = "LogSession";

  late final  docId;
  LogsIndirectR4(this.docId);


  @override
  _LogsIndirectR4State createState() => _LogsIndirectR4State(docId);
...
class _LogsIndirectR4State extends State<LogsIndirectR4> {
  final docId;
  _LogsIndirectR4State(this.docId);
                      ...
                      onPressed: () async {
                        ...
                        if (title != null) {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => LogsIndirectR4(docId),
                            ),
                          );
                        }
                      })
