...
class LogsDirectR4 extends StatefulWidget {
  static String TAG = "LogSession";

  late final  docId;
  LogsDirectR4(this.docId);


  @override
  _LogsDirectR4State createState() => _LogsDirectR4State(docId);

}
class _LogsDirectR4State extends State<LogsDirectR4> {
  final docId;
  _LogsDirectR4State(this.docId);
