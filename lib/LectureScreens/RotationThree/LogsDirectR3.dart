...
class LogsDirectR3 extends StatefulWidget {
  static String TAG = "LogSession";

  late final  docId;
  LogsDirectR3(this.docId);


  @override
  _LogsDirectR3State createState() => _LogsDirectR3State(docId);

}
class _LogsDirectR3State extends State<LogsDirectR3> {
  final docId;
  _LogsDirectR3State(this.docId);
