...
class LogsIndirectR3 extends StatefulWidget {
  static String TAG = "LogSession";

  late final  docId;
  LogsIndirectR3(this.docId);


  @override
  _LogsIndirectR3State createState() => _LogsIndirectR3State(docId);
...
class _LogsIndirectR3State extends State<LogsIndirectR3> {
  final docId;
  _LogsIndirectR3State(this.docId);
                      ...
                      onPressed: () async {
                        ...
                        if (title != null) {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => LogsIndirectR3(docId),
                            ),
                          );
                        }
                      })
