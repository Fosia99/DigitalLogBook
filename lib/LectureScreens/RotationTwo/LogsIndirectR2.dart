...
class LogsIndirectR2 extends StatefulWidget {
  static String TAG = "LogSession";

  late final  docId;
  LogsIndirectR2(this.docId);


  @override
  _LogsIndirectR2State createState() => _LogsIndirectR2State(docId);
...
class _LogsIndirectR2State extends State<LogsIndirectR2> {
  final docId;
  _LogsIndirectR2State(this.docId);
                      ...
                      onPressed: () async {
                        ...
                        if (title != null) {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => LogsIndirectR2(docId),
                            ),
                          );
                        }
                      })
